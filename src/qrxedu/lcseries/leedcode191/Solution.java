package qrxedu.lcseries.leedcode191;
...
public class Solution {
    ...
    public int hammingWeight1(int n){
         ...
         */
        /*
        之所以是010101...而不是1010101..的原因是:
        如果是101010..,n&..统计的就是k组的高位,想要统计低位需要(n<<1) && ..
        而将n << 1 有可能会导致n的符号位从0变为1,也就是从正数变成了负数.
        也就是说位运算中如果左移和右移都可以,尽量右移(因为右移不会改变符号位)
        当然如果有负数的话另外考虑(左移和右移都不行)
         */
        //每组高位1加上低位1
